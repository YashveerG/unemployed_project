...
<title>Un-Employed Employer's Login Page</title>
</head>
<body>
	<div class="container">
			<div class="row main" align="center">
				...
				<form class="form-horizontal" method="post" action="employer_login"> 
						...
						<div class="form-group">
							...
							<div class="cols-sm-10" style="width: 324px;"> 
								<div class="input-group" style="margin-left: 50px;"> 
									...
									<input type="email" class="form-control" name="mail" placeholder="localpart@domain" autofocus required style="font-family : Verdana; font-size: 14px;"/> 
								</div>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="cols-sm-10" style="width: 325px;"> 
								<div class="input-group" style="margin-left: 51px;">
									...
									<input type="password" class="form-control" name="password" placeholder="* * * * * * * *" required style="font-family : Verdana; font-size: 14px;"/>
								</div>
							</div>
						</div>
