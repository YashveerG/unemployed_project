			...
			<div class="row main">
				<div class="panel-heading">  
					<div class="panel-title text-center">
						<h1 class="title" style="color: green; margin-left: 170px; text-decoration: underline;">Registration Form</h1>																
					</div>					
				</div>
				...
				<form class="form-horizontal" method="post" action="candidate_register">  
						...
						<div class="form-group"> 						
							<sup style="color: red; float: right; margin-right: 260px; margin-top:20px; font-size: 20px">*</sup>
						...
						<div class="form-group">
							...
							<div class="cols-sm-10" style="width: 502px;">
								<div class="input-group" style="margin-left: 77px;">
									...
									<input type="number" class="form-control" name="mobile" required placeholder="Eg:- 9876543210"  autocomplete="off" min="7000000000" max="9999999999" style="font-family : Verdana; font-size: 20px;"/>
								</div>
							</div>
						</div>
