...
@WebServlet("/By_date_process")
public class By_date_process extends HttpServlet 
{
	...
	{		
		...
		String searchByDate=request.getParameter("search_date");
		...
		try
		{
			    ...
			    while(rs.next())
			    {
			    	if(searchByDate.equals(rs.getDate("resume_sent_date")))
			    	{
